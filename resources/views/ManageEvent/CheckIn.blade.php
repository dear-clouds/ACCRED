                    ...
                    <ul v-if="searchResultsCount > 0" class="list-group" id="attendee_list" v-cloak>
                        ...
                        <br>
                            ...
                            <br />
                                ...
                                <button data-modal-id="showCheckInModal-{{ $event_id }}-@{{ attendee.id }}" href="javascript:void(0);"  data-href="@{{ attendee.id }}/modal" class="loadModal btn btn-success" type="button">Check-in</button>
